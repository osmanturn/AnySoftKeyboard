...
import com.yek.keyboard.anysoftkeyboard.LayoutSwitchAnimationListener;
...
public abstract class AnySoftKeyboardSwipeListener extends AnySoftKeyboardKeyboardTagsSearcher {
    ...
    public void onSwipeRight( boolean twoFingersGesture) {
        ...
        if (keyCode != 0) mSwitchAnimator.doSwitchAnimation(LayoutSwitchAnimationListener.AnimationType.SwipeRight, keyCode);
    }
    ...
    public void onSwipeLeft(boolean twoFingersGesture) {
        ...
        if (keyCode != 0) mSwitchAnimator.doSwitchAnimation(LayoutSwitchAnimationListener.AnimationType.SwipeLeft, keyCode);
    }
