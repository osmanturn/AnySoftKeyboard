...
public class KeyboardCondenser {
    ...
    private void splitKeys(final int keyboardWidth, final int watershedLineX, final float condensingFactor) {
        ...
        int currentY = 0;
        Stack<Keyboard.Key> rightKeys = new Stack<>();
    ...
    int stackRightSideKeyForLater(Stack<Keyboard.Key> rightKeys, Keyboard.Key k, int targetWidth) {
        int currentRightX;
        rightKeys.push(k);
    ...
    int condenseLeftSide(final float CONDENSING_FACTOR, int currentLeftX,
                         Keyboard.Key k, int targetWidth) {
    ...
    void condenseRightSide(final float CONDENSING_FACTOR,
                           final int keyboardWidth, int currentRightX, Stack<Keyboard.Key> rightKeys,
