...
import com.yek.keyboard.keyboards.AnyKeyboard.HardKeyboardTranslator;
...
public class KeyboardSwitcher {
    ...
    private int mKeyboardRowMode = Keyboard.KEYBOARD_ROW_MODE_NORMAL;
    ...
    private static int getKeyboardMode(EditorInfo attr) {
        ...
        switch (variation) {
            ...
            case EditorInfo.TYPE_TEXT_VARIATION_WEB_EMAIL_ADDRESS:
                return Keyboard.KEYBOARD_ROW_MODE_EMAIL;
            case EditorInfo.TYPE_TEXT_VARIATION_URI:
                return Keyboard.KEYBOARD_ROW_MODE_URL;
            ...
            case EditorInfo.TYPE_TEXT_VARIATION_LONG_MESSAGE:
                return Keyboard.KEYBOARD_ROW_MODE_IM;
