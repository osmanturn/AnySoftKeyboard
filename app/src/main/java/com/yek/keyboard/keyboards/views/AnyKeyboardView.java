...
import com.yek.keyboard.keyboards.AnyKeyboard.AnyKey;
import com.yek.keyboard.keyboards.ExternalAnyKeyboard;
...
public class AnyKeyboardView extends AnyKeyboardViewWithMiniKeyboard implements InputViewBinder {
    ...
    public void openUtilityKeyboard() {
        dismissAllKeyPreviews();
        if (mUtilityKey == null) {
            mUtilityKey = new AnyKey(new Keyboard.Row(getKeyboard()), getThemedKeyboardDimens());
    ...
    public void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        // switching animation
        if (mAnimationLevel != AskPrefs.AnimationsLevel.None && keyboardChanged
                && (mInAnimation != null)) {
