...
import com.yek.keyboard.dictionaries.DictionaryAddOnAndBuilder;
import com.yek.keyboard.dictionaries.ExternalDictionaryFactory;
import com.yek.keyboard.dictionaries.TextEntryState;
import com.yek.keyboard.dictionaries.sqlite.AutoDictionary;
import com.yek.keyboard.ime.AnySoftKeyboardWithQuickText;
import com.yek.keyboard.keyboards.AnyKeyboard;
import com.yek.keyboard.keyboards.CondenseType;
import com.yek.keyboard.keyboards.Keyboard;
import com.yek.keyboard.keyboards.KeyboardAddOnAndBuilder;
import com.yek.keyboard.keyboards.KeyboardSwitcher;
import com.yek.keyboard.keyboards.physical.HardKeyboardActionImpl;
import com.yek.keyboard.keyboards.physical.MyMetaKeyKeyListener;
import com.yek.keyboard.keyboards.views.CandidateView;
import com.yek.keyboard.quicktextkeys.QuickKeyHistoryRecords;
import com.yek.keyboard.receivers.PackagesChangedReceiver;
import com.yek.keyboard.receivers.SoundPreferencesChangedReceiver;
import com.yek.keyboard.receivers.SoundPreferencesChangedReceiver.SoundPreferencesChangedListener;
import com.yek.keyboard.theme.KeyboardTheme;
import com.yek.keyboard.theme.KeyboardThemeFactory;
import com.yek.keyboard.ui.VoiceInputNotInstalledActivity;
import com.yek.keyboard.ui.dev.DeveloperUtils;
import com.yek.keyboard.ui.settings.MainSettingsActivity;
import com.yek.keyboard.utils.ChewbaccaOnTheDrums;
import com.yek.keyboard.utils.IMEUtil;
import com.yek.keyboard.utils.Logger;
import com.yek.keyboard.utils.ModifierKeyState;
import com.yek.keyboard.utils.Workarounds;
...
public abstract class AnySoftKeyboard extends AnySoftKeyboardWithQuickText implements SoundPreferencesChangedListener {
    ...
    private void onFunctionKey(final int primaryCode, final Keyboard.Key key, final int multiTapIndex, final int[] nearByKeyCodes, final boolean fromUI) {
    ...
    private void onNonFunctionKey(final int primaryCode, final Keyboard.Key key, final int multiTapIndex, final int[] nearByKeyCodes, final boolean fromUI) {
        if (BuildConfig.DEBUG) Logger.d(TAG, "onFunctionKey %d", primaryCode);
    ...
    private void handleCharacter(final int primaryCode, final Keyboard.Key key, final int multiTapIndex, int[] nearByKeyCodes) {
        if (BuildConfig.DEBUG)
    ...
    private void showOptionsMenu() {
        showOptionsDialogWithData(getText(R.string.ime_name), R.mipmap.ic_app_icon,
                new CharSequence[]{
